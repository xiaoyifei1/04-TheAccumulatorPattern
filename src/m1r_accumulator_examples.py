...
#
#              for k in range(r - s): need plus a
#                  count = 0 define before the loop
#                  if math.cos(r) > 0:
#                      count = 1 need add +count
#                  return count
#
