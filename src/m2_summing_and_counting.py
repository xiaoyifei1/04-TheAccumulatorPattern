...
def run_test_sum_more_cosines():
    ...
    # -------------------------------------------------------------------------
    # Test 2:
    expected = 1.66445777519  # This is APPROXIMATELY the correct answer.
...
# Test 2:
    expected = -0.39532517882  # This is APPROXIMATELY the correct answer.
    answer = sum_more_cosines(-4, 2)
    print('Test 1 expected:', expected, '(approximately)')
    if answer is not None:
        print('       actual:  ', round(answer, 5))
    else:
